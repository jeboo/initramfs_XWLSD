...
/sbin/busybox echo 5.6 CF - 6.0.2.8 > /customkernel/property/customkernel.cwm.version
/sbin/busybox echo 4.35 > /customkernel/property/customkernel.cwm.touch.build
/sbin/busybox echo true > /customkernel/property/customkernel.base.PhilZ-cwm6
/sbin/busybox echo 4.35 > /customkernel/property/customkernel.base.version
/sbin/busybox echo XWLSD-OXX > /customkernel/property/customkernel.firmware.name
